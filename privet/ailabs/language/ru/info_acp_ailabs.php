...
$lang = array_merge($lang, [
	...
	'LBL_AILABS_SETTINGS_DESC'		=> 'Пожалуйста, посетите 👉 <a href="https://github.com/privet-fun/phpbb_ailabs" target="_blank" rel="nofollow">https://github.com/privet-fun/phpbb_ailabs</a> для получения подробных инструкций по настройке и примеров.',
	...
	'LBL_AILABS_QUOTE_FORUMS'		=> 'Цитирование или <a href="https://www.phpbb.com/customise/db/extension/simple_mentions/" target="_blank" rel="nofollow">упоминание</a>',
	'LBL_AILABS_ENABLED'			=> 'Включено',
	'LBL_AILABS_SELECT_FORUMS'		=> 'Выберите форумы...',

	'LBL_AILABS_BOT_URL'			=> 'URL бота (тест)',
	...
	'LBL_AILABS_IP_VALIDATION'				=> '⚠️ Предупреждение: Администрировать > Общие > Конфигурация сервера > Безопасность > ' .
		...
		'(например <a href="https://www.phpbb.com/customise/db/extension/login_required" target="_blank" rel="nofollow">Login Required</a>). ' .
		'Установите проверку IP-адреса сессии в значение "Нет" или добавьте "/ailabs/*" в белый список расширений. ' .
		'Пожалуйста, обратитесь к <a href="https://github.com/privet-fun/phpbb_ailabs#troubleshooting" target="_blank" rel="nofollow">разделу по ' .
	...
	'LBL_AILABS_API_DOCS'			=> 'Документация API',
]);
