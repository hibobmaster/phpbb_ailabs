...
$lang = array_merge($lang, [
	...
	'AILABS_NO_PROMPT'					=> 'Задайте текст для генерации изображения.',
	'AILABS_ERROR_PROVIDE_URL' 			=> 'Пожалуйста прикрепите изображение или укажите URL-адрес изображения для анализа.',
	'AILABS_ERROR_PROVIDE_URL_2x'		=> 'Пожалуйста, прикрепите изображения или укажите URL-адреса изображений для исходного и целевого изображений для замены лица.',
