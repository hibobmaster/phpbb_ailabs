...
class release_1_0_9_schema extends \phpbb\db\migration\migration
{
	...
	{
		return array('\privet\ailabs\migrations\v1x\release_1_0_8_schema');
	}

	public function effectively_installed()
	{
		return isset($this->config['privet_ailabs_version']) && version_compare($this->config['privet_ailabs_version'], '1.0.9', '>=');
	}
